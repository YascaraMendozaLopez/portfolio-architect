    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      >
        <div className="h-[220px] sm:h-[260px] md:h-full">
          <img
            src={project.image}
            className="w-full h-full object-cover opacity-25 md:opacity-25"
          />
        </div>
        ...
        >
          ...
          <div className="flex flex-col h-full min-h-0 px-2 md:px-10">
            <div>
              <p className="text-accent-500 text-sm italic mb-2">
              ...
              <div className="mt-3 flex flex-wrap gap-3 md:gap-6">
              ...
              <div className="mt-4 h-[1px] bg-accent-500 w-full" />
            </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-6">
                <button
                  ...
                  className="
                    ...
                    rounded-lg
                    text-xs md:text-sm
                    font-nunito font-bold text-primary-300
